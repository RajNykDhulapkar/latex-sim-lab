...
1. The circuit behaves like an uncontrolled half wave rectifier with an RLE load once a firing gate pulse is given to the thyristor. It is observed that the output voltage waveform is the same as the load waveform, and the output current lags the output voltage due to the inductive component of the load.
