...
1. Upon observation, it can be noted that the simulated output voltage is closer to the calculated voltage, whereas the simulated output current deviates further from the calculated current. Additionally, the inclusion of the freewheeling diode results in an abrupt cutoff of output current in the rectifier circuit as the AC source supply reaches zero volts, as the lagging current begins to flow through the freewheeling diode instead of the rectifier circuit.
