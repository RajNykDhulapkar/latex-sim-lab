...
The observed values indicate that the simulated output voltage is close to the calculated voltage, but the simulated output current varies from the calculated current. Moreover, the freewheeling diode's integration leads to an immediate cutoff of output current in the rectifier circuit, as the lagging current flows through the freewheeling diode instead of the rectifier circuit when the source AC supply reaches zero volts.
