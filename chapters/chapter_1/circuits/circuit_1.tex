...
The simulated values match the theoretical values well, indicating that the circuit is operating as intended. Since the load is resistive, the output current is in phase with the output voltage. The output voltage and current waveforms reveal that the diode is forward-biased during the positive half-cycle of the AC source.
