...
The circuit requires triggering pulses to produce an output voltage. Once the thyristors are triggered, the circuit behaves as a full bridge uncontrolled rectifier. The simulated values are close to the theoretical values. Since the load is resistive, the output voltage and current are in phase. The output DC signal has twice the frequency of the input AC signal, which is due to full-wave rectification.
