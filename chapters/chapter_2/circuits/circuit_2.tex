...
The circuit will not produce any output voltage until the thyristors are triggered. Once triggered, the circuit operates as a full bridge uncontrolled rectifier. The simulated values closely resemble the theoretical values. Since the load is resistive, the output voltage and current are in phase. The output DC signal has twice the frequency of the input AC signal, which is due to full-wave rectification.
