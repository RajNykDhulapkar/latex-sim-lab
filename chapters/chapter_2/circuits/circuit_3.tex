...
Theoretical and simulated values coincide accurately. On supplying gate pulses, the full bridge rectifier with RL load produces output that is similar to the half-bridge rectifier with RL load, but with double the frequency. Due to the inductive load, the output current lags behind the output voltage, resulting in a delay in the thyristors' switching off. As the thyristors in the rectifier legs briefly allow the negative half cycle of the AC voltage signal to conduct, a momentary negative output voltage is produced.
